...
export default function Collection() {
  ...
  <div className="leftSection">
    <Typography variant="" className='footerLeft'>Copyright @ 2025 Dolium</Typography>
  </div>
  ...
  <div className="rightSection">
       ...
       <Typography className='powerByCl'>
       Powered by
       </Typography>
       <Typography className='DoliumFooter' sx={{fontSize:'20px'}}>
        Dolium
       </Typography>
      <Typography className='footerViNum'>
      V1.2411.13
      </Typography>
      </div>
